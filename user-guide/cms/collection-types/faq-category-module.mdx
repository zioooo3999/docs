...
The FAQ Category module in the Tempe Park CMS is used to manage the categories of FAQ data available on the Tempe Park website. This module functions as a means of grouping questions and answers so that FAQ information can be organized more neatly, structured, and easily found by website visitors.

Through this module, administrators can create and organize FAQ categories as needed, such as general information, tickets, facilities, activities, reservations, and other categories. These categories will then be used in the FAQ module to group each question and answer displayed on the website.
...
Here is the main display of the FAQ Category menu:<br />\]

<Frame>
  ![0 (31)](/images/0-\(31\).png "0 (31)")
</Frame>
...
The following is a frontend view based on data taken from the FAQ Category collection module. The contents of this module will become the frontend content on the FAQ page, taking the form of a visual category tab:

<Frame>
  ![0 (33)](/images/0-\(33\).png "0 (33)")
</Frame>

<CardGroup cols={3}>
  <Card title="Visual Category Tabs" color="#10b981" icon="folder-tree">
    Powers the frontend category navigation tabs on the visitor-facing FAQ page.
  </Card>

  <Card title="Custom Tab Ordering" color="#38bdf8" icon="arrow-down-1-9">
    Controls the display sequence of category tabs using custom order index values.
  </Card>

  <Card title="Multilingual Navigation" color="#f59e0b" icon="language">
    Renders localized category titles in English, Indonesian, and Chinese.
  </Card>
</CardGroup>
